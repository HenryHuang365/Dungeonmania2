...
public class GameBuilder {
    ...
    private void loadSavedConfig() {
        String configFile = String.format("/savedconfigs/%s.json", configName);
        try {
            config = new JSONObject(FileLoader.loadResourceFile(configFile));
        } catch (IOException e) {
            e.printStackTrace();
    ...
    private void loadSavedDungeon() {
        String dungeonFile = String.format("/saveddungeons/%s.json", dungeonName);
        // System.out.println("dungeonFile" + dungeonFile);
        try {
            dungeon = new JSONObject(FileLoader.loadResourceFile(dungeonFile));
