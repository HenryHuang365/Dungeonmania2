...
public class BattleFacade {
    ...
    public void battle(Game game, Player player, Enemy enemy) {
        ...
        double initialPlayerHealth = player.getHealth(player);
        double initialEnemyHealth = enemy.getHealth(player);
        ...
        BattleStatistics playerBuff = new BattleStatistics(0, 0, 0, 1, 1, player, true);
        ...
        if (effectivePotion != null) {
            ...
            for (BattleItem item : player.getBattlEntities()) {
