...
public class EntityFactory {
    ...
    public Player buildPlayer(Position pos) {
        ...
        return new Player(pos, playerHealth, playerAttack, 0);
    }
    ...
    public Hydra buildHydra(Position pos) {
        ...
        config.optDouble("hydra_health_increase_rate", Hydra.DEFAULT_HEALTH_INCREASE_RATE);
        double hydraHealthIncreaseAmount =
        config.optDouble("hydra_health_increase_amount", Hydra.DEFAULT_HEALTH_INCREASE_AMOUNT);
    ...
    public Assassin buildAssassin(Position pos) {
        ...
        double assassinBribeRate = config.optDouble("assassin_bribe_fail_rate", Assassin.DEFAULT_BRIBE_FAILED_RATE);
        return new Assassin(pos, assassinHealth, assassinAttack,
        assassinBribeAmount, assassinBribeRadius, assassinBribeRate);
    }
    ...
    public MidnightArmour buildMidnightArmour() {
        double extraAttack = config.optDouble("midnight_armour_attack", MidnightArmour.DEFAULT_EXTRA_ATTACK);
        double extraDefence = config.optDouble("midnight_armour_defence", MidnightArmour.DEFAULT_EXTRA_DEFENCE);
